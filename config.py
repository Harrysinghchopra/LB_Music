...
OWNER_ID = int(getenv("OWNER_ID", "6916513278"))
...
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/kunn_bot_support")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://radare.arzfun.com/api/tg/photo?id=AgACAgUAAxkBAAEBfI5m3byYnToCBLEAAWJ6LYzgfbKqjMwAAoHBMRtW_PBWK276nj5JypEBAAMCAAN5AAM2BA"
)
PING_IMG_URL = getenv(
